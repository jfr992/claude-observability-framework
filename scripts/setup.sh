#!/bin/bash
#
# Claude Code Metrics - Setup Script (Mac & Linux)
# Sets up telemetry, monitoring stack, and identity tracking
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/jfr992/claude-observability-framework/main/scripts/setup.sh | bash
#   or
#   ./scripts/setup.sh
#
...
echo -e "${BLUE}"
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║       Claude Code Metrics - Setup                            ║"
